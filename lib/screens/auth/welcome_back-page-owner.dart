...
class _WelcomeBackPageOwnerState extends State<WelcomeBackPageOwner> {
  TextEditingController email = TextEditingController(text: 'sar@k.com');
  ...
  void userLogin() async {
    ...
    var url = url1 + "loginapiowner.php";
    ...
    if (deccodedResponse == "true") {
      Navigator.of(context)
          .pushNamed(ProfilePageSeller.routeName, arguments: email.text);
